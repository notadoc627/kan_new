...
def train_and_validate(model, train_loader, val_loader, num_epochs, device):
    ...
    return train_losses, val_losses, val_r2s, val_mapes, best_model_path, log_dir, training_time
...
train_losses, val_losses, val_r2s, val_mapes, best_model_path, log_dir, training_time = train_and_validate(model, train_loader, val_loader, num_epochs, device)
...
predictions_csv_path = os.path.join(log_dir, 'predictions.csv')
